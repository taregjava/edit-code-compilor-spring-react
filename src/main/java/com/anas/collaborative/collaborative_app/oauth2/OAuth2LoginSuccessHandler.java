package com.anas.collaborative.collaborative_app.oauth2;



import com.anas.collaborative.collaborative_app.entity.RegistrationSource;
...
public class OAuth2LoginSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws ServletException, IOException {
        ...
        if ("github".equals(oAuth2AuthenticationToken.getAuthorizedClientRegistrationId())) {
            ...
            // Ensure "email" and "name" values are properly checked for null
            String email = attributes.getOrDefault("email", "") != null ? attributes.getOrDefault("email", "").toString() : "";
            String name = attributes.getOrDefault("name", "") != null ? attributes.getOrDefault("name", "").toString() : "";
